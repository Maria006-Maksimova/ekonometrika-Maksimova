...
Скриншот работы
 ![Случайные числа, гистограмма, описательная статистика](https://github.com/Maria006-Maksimova/ekonometrika-Maksimova/blob/main/1.png)
## 3.	Выводы:
...
•	Теоретическое значение $$y^{\prime} = -200 + 70 \cdot \ln(x)$$

•	Квадраты отклонений:  $$y={(ŷ-y)^2}$$ и $$y={(y-ỹ)^2}$$
...
Скриншот работы
![Парная корреляция](https://github.com/Maria006-Maksimova/ekonometrika-Maksimova/blob/main/2.png)
...
Скриншот работы
![Парная регрессия](https://github.com/Maria006-Maksimova/ekonometrika-Maksimova/blob/main/3.png)
...
Скриншот работы
 ![Множественная регрессия](https://github.com/Maria006-Maksimova/ekonometrika-Maksimova/blob/main/4.png)
## 6. Выводы:
...
Скриншот работы
 ![Множественная регрессия нарушения допущений](https://github.com/Maria006-Maksimova/ekonometrika-Maksimova/blob/main/5.png)
## 4.	Выводы:
...
Скриншот работы
 ![Нелинейная регрессия и способы реализации](https://github.com/Maria006-Maksimova/ekonometrika-Maksimova/blob/main/6.png)
## 3.	Выводы:
...
Скриншот работы
![R](https://github.com/Maria006-Maksimova/ekonometrika-Maksimova/blob/main/7.png)
## 6.	Выводы:
